        ...
        success:function (data) {
            ...
            for(var i = 0; i < data.length; i++) {
                ...
                $('#second_side_right .contacts-list').append('<li class="online">\n' +
                    '<a>\n' +
                    '<i class="fa fa-file-text-o" title="online" rel="tooltip-bottom"></i> ' + note.title + '&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 10px;">(' + formatDate(new Date(note.modifyTime), "yyyy/MM/dd hh:mm") + ')</pan><button type="button" class="btn btn-default btn-xs btn_position btn_slide_down"><i class="fa fa-chevron-down"></i></button>\n' +
                    '</a>\n' +
...
function updateNormalNote(){
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            $('#second_side_right .contacts-list li .checked').html('<i class="fa fa-file-text-o" title="online" rel="tooltip-bottom"></i> ' + note.title + '&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 10px;">(' + formatDate(new Date(note.modifyTime), "yyyy/MM/dd hh:mm") + ')</pan><button type="button" class="btn btn-default btn-xs btn_position btn_slide_down"><i class="fa fa-chevron-down"></i></button>\n');
        }
    })
}
